...
from data_discovery_ai.utils.agent_tools import save_to_file, load_from_file, get_text_embedding
...
class TestAgentTools(unittest.TestCase):
    ...
    def test_save_to_file(self, mock_open, mock_pickle_dump, mock_logger):
        ...
        mock_pickle_dump.assert_called_once_with(self.test_obj, mock_open.return_value.__enter__())
    ...
    def test_get_text_embedding(self, mock_embedding_model, mock_tokenizer_model):
        ...
        mock_model_output.last_hidden_state.__getitem__.return_value.numpy.return_value = fake_output
