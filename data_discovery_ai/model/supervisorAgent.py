...
from data_discovery_ai.model.descriptionFormatingModel import DescriptionFormatingAgent as DescriptionFormatingAgent
from data_discovery_ai.model.linkGroupingModel import LinkGroupingAgent as LinkGroupingAgent
from data_discovery_ai.pipeline.pipeline import KeywordClassifierPipeline, DataDeliveryModeFilterPipeline
...
class SupervisorAgent(BaseAgent):
    ...
    def take_action(self, document_id):
        ...
        resp = connector.fetch_record_by_documentId(client=client, index=index, document_id=document_id)
